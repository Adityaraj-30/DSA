// Ques15 - Write a Program to implement a priority queue using heap data structure.
...
int main()
{
    ...
    do
    {
        ...
        {
            cout << "\n------DELETE THE ELEMENT FROM THE HEAP------ " << endl;
            cout << "\n------ENTER THE ELEMENT AT INDEX --->" << endl;
            cin >> val;
            m.deleteKey(val);
        }
        else if (option == 4)
        {
            cout << "\n------HEIGHT OF THE HEAP IS:---> " << m.height() << endl;
        }
        else if (option == 5)
        {

            cout << "\n------MINIMUM ELEMENT OF THE HEAP---> " << endl;
            cout << m.getMin();
        }
        else if (option == 6)
        {
            cout << "\n------EXTRACT MIN VALUE :--->" << endl;
            cout << m.extractMin() << endl;
        }
        else if (option == 7)
        {
            cout << "\n------DISPLAY THE HEAP VALUE:---> " << endl;
            m.display();
        }
        else if (option == 8)
        {
