/*Ques11)- Write a program to implement Binary Search Tree which supports the following operations: 
...
(iv) Display the elements of the BST in pre_order, in_order, and post_order traversal 
...
int main()
{
    ...
    int item,n,y,h;
	char ch = 'y';
	cout<<"\t\t___________BINARY SEARCH TREE__________\n";
	while(ch=='y' || ch=='Y')
	{
